		...
		res.on('data', function (chunk) {
  		...
  		res.on('end', function () {
       		...
       		if (action == 'check') {
       			...
       			self.info.coinbase = "Lisk " + jsonObject["version"] + jsonObject["commit"].substring(0,8) + " Build:(" +jsonObject["build"]+")";
				self.info.node = "Lisk " + jsonObject["version"] + jsonObject["commit"].substring(0,8) + " Build:(" +jsonObject["build"]+")";
