...
sed -i -e "s/\"RPC_PORT\"        : \"8000\"/\"RPC_PORT\"        : \"$LISK_PORT\"/g" app.json
sed -i -e "s/\"LISTENING_PORT\"  : \"8000\"/\"LISTENING_PORT\"  : \"$LISK_PORT\"/g" app.json
...
sed -i -e "s/\"IS_FORGING\"      : \"no\"/\"IS_FORGING\"      : \"$LISK_ISFORGING\"/g" app.json
git pull
npm install
node app.js
